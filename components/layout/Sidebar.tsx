      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              fontFamily:'var(--fp)',fontSize:9,color:'#ffffff',
          ...
          {navItems.map(item=>{
            ...
            return(
              ...
              >
                ...
                {/* Label */}
                <span style={{
                  fontFamily:'var(--fp)',fontSize:11,letterSpacing:1,
                  opacity:open?1:0,
        ...
        {isStaff && (
          ...
          onMouseLeave={e=>{
            ...
            <span style={{
              fontFamily:'var(--fp)',fontSize:11,letterSpacing:1,color:'inherit',
              opacity:open?1:0,
              transform:open?'translateX(0)':'translateX(-6px)',
              transition:'opacity .18s, transform .18s',
            }}>ADMIN PANEL</span>
        ...
        <div style={{borderTop:'1px solid rgba(255,255,255,0.06)',flexShrink:0}}>
          <div style={{
            ...
            <div style={{
              ...
              display:'flex',alignItems:'center',justifyContent:'center',
              fontSize:11,color:'#bf5af2',fontFamily:'var(--fp)',
            }}>
              {avatar}
            </div>
            <div style={{
              ...
              <div style={{fontFamily:'var(--fp)',fontSize:11,color:'var(--text)',
                whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis'}}>
                {uname}
              </div>
              <div style={{fontFamily:'var(--fp)',fontSize:9,color:'var(--dim2)',marginTop:3}}>
                LV{level} · {xp}XP
              </div>
            </div>
          </div>
