        ...
        <div style={{
          ...
          <div style={{ flex:1, padding:'0 28px', display:'flex', alignItems:'center', gap:16 }}>
            <div style={{ display:'flex', alignItems:'center', gap:10 }}>
              ...
              <span style={{ fontFamily:'var(--fp)', fontSize:10, color:'#00e5ff', letterSpacing:3, textShadow:'0 0 10px rgba(0,229,255,.3)' }}>{t('dash_title')}</span>
            </div>
      ...
      >
        ...
        <div style={{ flex:1, padding:'18px 16px', display:'flex', flexDirection:'column', justifyContent:'space-between' }}>
          <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:10 }}>
            ...
            <div style={{ fontFamily:'var(--fp)', fontSize:9, color:zone.col, letterSpacing:1, textShadow:`0 0 8px ${zone.col}44` }}>{zone.label}</div>
          </div>
        ...
        <div style={{ display:'flex', alignItems:'center', paddingRight:14 }}>
          <div style={{ fontFamily:'var(--fp)', fontSize:10, color:`${zone.col}33`, transition:'all .18s' }}>›</div>
        </div>
      </div>
    </a>
  )
